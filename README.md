...
| dir |__REQUIRED__ |Directory mount to|
| flavor |"debian-systemd" |Flavor depends of OS and init system|
| host |__REQUIRED__ |NFS server host|
...
File a GitHub [issue](https://github.com/cloudposse/terraform-template-user-data-nfs/issues), send us an [email](mailto:hello@cloudposse.com) or reach out to us on [Gitter](https://gitter.im/cloudposse/).
...
If you are interested in being a contributor and want to get involved in developing `terraform-template-user-data-nfs`, we would love to hear from you! Shoot us an [email](mailto:hello@cloudposse.com).
...
|[![Erik Osterman][erik_img]][erik_web]<br/>[Erik Osterman][erik_web] |[![Igor Rodionov][igor_img]][igor_web]<br/>[Igor Rodionov][igor_img] |[![Sergey Vasilyev][sergey_img]][sergey_web]<br/>[Sergey Vasilyev][sergey_web] |
|---|---|---|
